...
namespace MVCProject.Migrations
{
    ...
    [Migration("20220122145946_complexdb2")]
    partial class complexdb2
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MVCProject.Models.CourseAssignment", b =>
                {
                    b.Property<int>("CourseID")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MVCProject.Models.OfficeAssignment", b =>
                {
                    b.Property<int>("InstructorID")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MVCProject.Models.Department", b =>
                {
                    b.HasOne("MVCProject.Models.Instructor", "Administrator")
                        .WithMany()
                        .HasForeignKey("InstructorID");
            ...
            modelBuilder.Entity("MVCProject.Models.OfficeAssignment", b =>
                {
                    b.HasOne("MVCProject.Models.Instructor", "Instructor")
                        ...
                        .HasForeignKey("MVCProject.Models.OfficeAssignment", "InstructorID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
